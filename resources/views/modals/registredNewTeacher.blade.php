    ...
    <div class="modal-dialog modal-lg mt-md-n3 modal-md mt-5 bg-linear-official-img1" style="position: relative;top: 50px;">
        <div class="modal-content bg-linear-official-50" style="border-style: solid; border-radius: 0; !important;">
            ...
            <div class="modal-body w-100">
                ...
                <form id="formRegisterNewTeacher" class="form-horizontal" role="form" method="POST" action="{{ route('teachersm.create.teachers', true) }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="w-100 mx-auto">
                        ...
                        <div class="mx-auto mt-2 d-flex justify-content-between" style="width: 85%">
                            <div class="" style="width: 74%">
                                ...
                                <input type="text" class="form-control w-100"  name="name" id="name" placeholder="Veuillez renseigner les nom et prenoms">
                        ...
                        <div class="mx-auto mt-2 d-flex justify-content-around" style="width: 85%">
                            ...
                            <div style="width: 37%;" class="">
                                <label for="role" class="m-0 p-0">Role</label>
                        ...
                        <div class="mx-auto mt-2 d-flex justify-content-between" style="width: 85%">
                            <div class="mx-auto" style="width: 48.8%;">
                                ...
                                <input type="email" class="m-0 p-0 form-control p-1 " name="email" id="email" placeholder="Veuillez renseigner l'addresse mail">
                                <small class="help-block"></small>
                            </div>
                            <div class="mx-auto" style="width: 48.8%;">
