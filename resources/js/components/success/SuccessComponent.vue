<template>
    <div class="modal fade" id="default" tabindex="-1" role="dialog" aria-labelledby="defaultLabel" aria-hidden="true" style="top: 100px !important;">
        <div class="modal-dialog modal-sm text-center border border-white">
            <div class="modal-content box-color-register-home px-3 pb-3 shadow">
                <div class="w-100 mx-auto p-3">
                    <h5>You're successfully registred now</h5>
